...
int16_t adamController::set_pulse_duty(int16_t output, float duty) {
...
int16_t adamController::start_pulse_output(int16_t output) {
...
int16_t adamController::stop_pulse_output(int16_t output) {
